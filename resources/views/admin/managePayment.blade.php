...
@section('content')
    <div class="row">
        <div class="col-8">Manage Payment</div>
        <div class="col-4">
            ...
            <table class="table">
                ...
                @foreach ($payment as $due)
                    <tr>
                        ...
                        <td>
                            <a href="{{route("admin.make.cashpayment",['std_id'=>$due->student_id,'id'=>$due->id]) }}" class="btn btn-success @if($due->status=="paid")disabled @endif">Paid</a>
                        </td>
                    </tr>
                @endforeach
            </table>
